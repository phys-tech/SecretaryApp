...
namespace SecretaryApp
{
    public partial class MainForm : Telerik.WinControls.UI.RadForm
    {
        ...
        private void AddTextToDocs()
        {
            ...
            String docText = "Инструкция по составлению личного кода сотрудника «ПромНефть» в головном офисе компании \r\n\r\n";
            docText += "Личный код сотрудника отображает три параметра, которые влияют на возможность доступа к определенной информации, а также зданиям и помещениям корпорации. Кроме того,  он отображает расположение постоянного рабочего места сотрудника, где он находится максимальное время, исключая сотрудников с разъездным характером работы, или работникам, выполняющим свои трудовые обязанности удаленно. ";
